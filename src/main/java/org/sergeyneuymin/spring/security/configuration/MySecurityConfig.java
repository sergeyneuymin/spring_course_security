...
//        auth.inMemoryAuthentication().withUser(userBuilder.username("sergey").password("sergey").roles("EMPLOYEE"));
//        auth.inMemoryAuthentication().withUser(userBuilder.username("petr").password("petr").roles("MANAGER", "HR"));
    }
